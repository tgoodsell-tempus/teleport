...
func TestIntegrationCRUD(t *testing.T) {
	...
	// Create Integration
	createIntegrationReq := ui.CreateIntegrationRequest{
	...
	// Update the integration to another AWSRoleARN
	...
	// Delete resource
	resp, err = webPack.DoRequest(http.MethodDelete, integrationsEndpoint+"/MyAWSAccount", ui.UpdateIntegrationRequest{
		AWSRoleARN: "arn:aws:iam::123456789012:role/OpsTeam",
	})
	require.NoError(t, err)
