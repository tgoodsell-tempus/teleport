...
func TestIntegrationMarshalCycle(t *testing.T) {
	ig, err := types.NewIntegration(
		...
		types.IntegrationSpecV1{
			AWSRoleARN: "arn:aws:iam::123456789012:role/DevTeams",
		},
	)
...
func TestIntegrationUnmarshal(t *testing.T) {
	...
	storedBlob := []byte(`{"kind":"integration","sub_kind":"aws-oidc","version":"v1","metadata":{"name":"some-integration"},"spec":{"aws_role_arn":"arn:aws:iam::123456789012:role/DevTeams"}}`)
