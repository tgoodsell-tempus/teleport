...
# the array before the EXIT trap fires and we get an unset variable error.
tmpfiles=''
...
error() {
	# shellcheck disable=SC2059 # we take a format string arg
	printf "$@" >&2
	printf '\n' >&2
	exit 1
}
